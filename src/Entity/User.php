...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?string $strava_id = null;

    #[ORM\Column(length: 255, nullable: true)]
    private ?string $garmin_id = null;
    ...
    public function setStravaId(?string $strava_id): static
    {
    ...
    public function getGarminId(): ?string
    {
        return $this->garmin_id;
    }

    public function setGarminId(?string $garmin_id): static
    {
